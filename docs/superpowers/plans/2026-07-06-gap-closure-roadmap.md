...
| **C — Meeting depth** | `2026-07-07-wave-c-meeting-depth.md` | Live floating transcript panel; multi-speaker diarization (sherpa-onnx per-segment embeddings, CPU — de-risked in `research/2026-07-07-diarization-derisk.md`, pyannote-via-HF rejected as gated); search across meeting transcripts. Calendar linkage DEFERRED (needs local Google OAuth; rename covers titling) | **in progress** |
...
| **E — QoL** | `2026-07-07-wave-e-qol.md` | Scratchpad (floating dictation notepad); dictionary starring/priority; settings + dictionary + snippets export/import | **in progress** |
